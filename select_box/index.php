    ...
    <div class="container">
        <div class="col-md-12" style="margin-bottom: 100px;">
            ...
            <select class="form-control" id="quocgia" name="quocgia">
                ...
                <?php
                    while ($rows_quocgia = mysqli_fetch_array($sql_quocgia)) {
                        echo '<option value="'.$rows_quocgia['id_quocgia'].'">'.$rows_quocgia['tenquocgia'].'</option>';
                    }
                ?>
            </select>
            <label>Thủ đô</label>
            <select class="form-control" id="thudo" name="thudo"></select>
        </div>
    </div>
